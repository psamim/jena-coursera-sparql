...
public class Modeling {
	...
	public void addLiteralStatement(String s, String p, Object o){
	 ...
	 public void createModel(Course course){
		...
		// String nsRDFS= "http://www.w3.org/2000/01/rdf-schema#";
		 ...
		 addLiteralStatement(co+course.getShortname(), co+"name", course.getCourseName());
		 addLiteralStatement(co+course.getShortname(), co+"id", course.getId());
		 addLiteralStatement(co+course.getShortname(), co+"has", course.getId());
	com.hp.hpl.jena.graph.Node blanknode= NodeFactory.createAnon();
